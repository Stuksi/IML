...
namespace iml
{
    ...
    private:
        std::string name;
    public:
        //! Parameterized constructor of class node_link. Initializes the class value with a non-empty name (upper-case string).
        ...
        //! Saves the node, by writing the children of the link to the file.
